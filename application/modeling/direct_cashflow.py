...
def generate_direct_cashflow_template(valuation_date, months_to_forecast):
    direct_cashflow = pd.DataFrame(
        index=[
            ...
            "Receipts From Intergroup Receivables",
            "Purchase Of Inventory",
            "Issue Of Equity And Intercompany Loans",
            "Purchase Of Other Non Current Or Current Assets",
            "Total Cash Inflows",
            "CASH OUTFLOWS",
            "Disbursements",
            "Interest Expense",
            ...
            "Sale Of Equity And Intercompany Loans",
            "Sale Of Other Non Current Or Current Assets",
            "Dividend Paid",
            "Tax Paid",
            "Total Cash Outflows",
