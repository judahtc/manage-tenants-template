...
def get_endpoint_details(variable: int):
    return {
        ...
        "/tenants/": "Retrieved All Companys or Created a New Tenant",
        f"/tenants/{variable}": f"Retrieved Company Details For {variable}",
        f"/tenants/{variable}": f"Deleted Company {variable}",
        f"tenants/{variable}/toggle-active": "Changed The Active State For The {variable}",
        "/users/": "Retrieve All Users For Company or Created A User",
        ...
        f"/users/{variable}": f"Viewed|Updated|Deleted User {variable}",
        ...
        f"/projects/{variable}": f"Viewed|Updated|Deleted Project {variable}",
